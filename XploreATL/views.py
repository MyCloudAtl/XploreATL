...
from .serializers import EaterySerializer, HotspotSerializer, ProfileSerializer, LocationSerializer, CustomUserSerializer, RatingSerializer
from .models import Eatery, Hotspot, Location, Profile, CustomUser, Rating
